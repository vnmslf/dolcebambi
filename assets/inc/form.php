...
$fromemail = array(
				'email' => 'admin@dolcebambi.ru', // Company's Email Address (preferably currently used Domain Name)
...
$recaptcha_secret = '6Ld0880pAAAAALI6M7xmcfp6Qyk-VWrm7NpsjWMR'; // Your reCaptcha Secret
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	if( $sendEmail == true ) {
		...
		header('Location: https://dolcebambi.ru/thank-you/');
	} else {
